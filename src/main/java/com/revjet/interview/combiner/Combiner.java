...
/**
 * com.revjet.interview.combiner.Combiner takes items from multiple input producers (think "streams" or "queues") and
...
public interface Combiner<T> {
    ...
    /**
     * Start combine queues according to priority
     */
    void start();
